    ...
    handleSubmit = ev =>{
        ...
        this.props.form.validateFields(async (err, values) => {
            ...
            if (parseFloat(result.code) === 0) {
                this.props.queryBaseInfo(); //登录成功后，将redux容器中的信息改成最新的
    ...
    render(){
        ...
        return <div className='personLoginBox'>
            <Form onSubmit={this.handleSubmit} className="login-form">
                ...
                <Form.Item>
        {/* 点击Log in按钮登录成功和失败做的事在handleSubmit里做了，登陆成功则跳转到上一个页面，失败则弹出一个提示框 */}
...
export default Form.create({ name: 'normal_login' })(connect({...action.person,...action.course})(Login));